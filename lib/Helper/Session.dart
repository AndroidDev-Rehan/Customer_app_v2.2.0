...
void hideAppbarAndBottomBarOnScroll(
  ...
  _scrollBottomBarController.addListener(() {
    if (_scrollBottomBarController.position.userScrollDirection ==
      ...
      if (!context.read<HomeProvider>().checkIsScrollingDown) {
        context.read<HomeProvider>().isScrollingDown(true);
        context.read<HomeProvider>().showBars(false);
      }
    } else {
      if (context.read<HomeProvider>().checkIsScrollingDown) {
        context.read<HomeProvider>().isScrollingDown(false);
...
getAppBar(
  ...
  return AppBar(
    ...
    actions:<Widget>[
      ...
      title == getTranslated(context, 'FAVORITE')! ? Container() :
      IconButton(
