...
class _SaleState extends State<Sale>
  ...
  _getSection(int i) {
    ...
    return saleList[i].productList!.length!=0?Padding(
                    ...
                    Padding(
                      ...
                      child: ClipRRect(
                          ...
                          child: Hero(
                            ...
                            tag: "SaleProIt$index${productList[index].id}",
                            child: FadeInImage(
                    ...
                    Padding(
                      ...
                      child: ClipRRect(
                          ...
                          child: Hero(
                            transitionOnUserGestures: true,
                            tag:
                                "SaleSecItem${saleList[secPos].productList![index].id}$secPos$index",
                            child: FadeInImage(
                              fadeInDuration: Duration(milliseconds: 150),
                              image: CachedNetworkImageProvider(
      ...
      apiBaseHelper.postAPICall(getSectionApi, parameter).then((getdata) {
        ...
        if (!error) {
          ...
          saleList.forEach((element) {
            print("values are ${element.title}");
          });
        } else {
            ...
            itemBuilder: (context, index) {
              return InkWell(
                child: Stack(
                  ...
                  children: [
                    curDis == index
                        ? SvgPicture.asset(imagePath + 'tap.svg',color: colors.primary,)
                        : Container(),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(
