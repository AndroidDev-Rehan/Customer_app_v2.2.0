          ...
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                if (index == reviewList.length && isLoadingmore) {
                  return const Center(child: CircularProgressIndicator(color: colors.primary,));
                } else {
                  return Container(
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          child: ClipRRect(
                            ...
                            child:
                              ...
                              image:
                                  CachedNetworkImageProvider(reviewList[index].userProfile!),
                              fit: BoxFit.fill,
                              height: 36,
                              width: 36,
        ...
        itemBuilder: (context, index) {
          return Padding(
            ...
            child: InkWell(
              ...
              child: Hero(
                tag: 'RevItem$index${reviewList[i].id}',
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(5.0),
                  child: FadeInImage(
                    image: CachedNetworkImageProvider(reviewList[i].imgList![index]),
                    height: 100.0,
                    width: 100.0,
