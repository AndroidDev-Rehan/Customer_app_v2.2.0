          ...
          child: Row(
            ...
            children: [
              TextButton.icon(
                  ...
                  label: Text(getTranslated(context, 'FILTER')!,style: TextStyle(color:  Theme
                      .of(context)
                      .colorScheme
                      .fontColor),)),
              TextButton.icon(
                  onPressed: sortDialog,
                  icon: Icon(Icons.swap_vert,color: colors.primary,),
                  label: Text(
                        ...
                        Hero(
                          ...
                          child: ClipRRect(
                              ...
                              child: Stack(
                                children: [
                                  FadeInImage(
                                    image: CachedNetworkImageProvider(widget.section_model!
                    ...
                    children: [
                      Hero(
                        ...
                        "SaleGrid${widget.sectionList![widget.index!]
                            .productList![index].id}${widget.index}$index",
                        child: ClipRRect(
                          borderRadius: BorderRadius.only(
      ...
      if (_isNetworkAvail) {
        try {
          var parameter = {
            ...
            PRODUCT_OFFSET: widget.section_model!.productList!.length
                .toString(),
